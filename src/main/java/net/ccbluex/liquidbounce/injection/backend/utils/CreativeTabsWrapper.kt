...
class CreativeTabsWrapper(val wrapped: WrappedCreativeTabs, name: String) : CreativeTabs(name) {
    ...
    override fun displayAllRelevantItems(items: NonNullList<ItemStack>) = wrapped.displayAllReleventItems(WrappedMutableList(
        items, IItemStack::unwrap, ItemStack::wrap))
