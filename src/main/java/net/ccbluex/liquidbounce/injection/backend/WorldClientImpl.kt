...
class WorldClientImpl(wrapped: WorldClient) : WorldImpl<WorldClient>(wrapped), IWorldClient {
    ...
    override fun setBlockState(blockPos: WBlockPos?, blockstate: IBlockState?, size: Int): Boolean = wrapped.setBlockState(BlockPos(blockPos!!.x,
        blockPos.y,
        blockPos.z),blockstate,size)
