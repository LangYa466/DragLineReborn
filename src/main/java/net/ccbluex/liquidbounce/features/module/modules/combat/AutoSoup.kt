...
class AutoSoup : Module() {
    ...
    fun onUpdate(event: UpdateEvent?) {
        ...
        val soupInHotbar = InventoryUtils2.findItem(36, 45, classProvider.getItemEnum(ItemType.MUSHROOM_STEW))
        ...
        val bowlInHotbar = InventoryUtils2.findItem(36, 45, classProvider.getItemEnum(ItemType.BOWL))
        ...
        val soupInInventory = InventoryUtils2.findItem(9, 36, classProvider.getItemEnum(ItemType.MUSHROOM_STEW))

        if (soupInInventory != -1 && InventoryUtils2.hasSpaceHotbar()) {
            if (openInventoryValue.get() && !classProvider.isGuiInventory(mc.currentScreen))
                return
