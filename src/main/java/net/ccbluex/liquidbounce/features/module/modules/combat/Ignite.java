...
public class Ignite extends Module {
   ...
   public void onUpdate(final UpdateEvent event) {
       ...
       final int lighterInHotbar =
               lighterValue.get() ? InventoryUtils2.findItem(36, 45, classProvider.getItemEnum(ItemType.FLINT_AND_STEEL)) : -1;
       final int lavaInHotbar =
               lavaBucketValue.get() ? InventoryUtils2.findItem(26, 45, classProvider.getItemEnum(ItemType.LAVA_BUCKET)) : -1;
