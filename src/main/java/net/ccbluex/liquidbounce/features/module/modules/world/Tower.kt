...
class Tower : Module() {
    ...
    fun onMotion(event: MotionEvent) {
        ...
        if (eventState == EventState.PRE) {
            ...
            val update = if (autoBlockValue.get()) {
                InventoryUtils2.findAutoBlockBlock() != -1 || thePlayer.heldItem != null && classProvider.isItemBlock(thePlayer.heldItem!!.item)
            } else {
    ...
    private fun place() {
        ...
        if (itemStack == null || !classProvider.isItemBlock(itemStack.item)) {
            ...
            blockSlot = InventoryUtils2.findAutoBlockBlock()
        ...
        get() {
            ...
            for (i in 36..44) {
                ...
                if (itemStack != null && classProvider.isItemBlock(itemStack.item)) {
                    ...
                    if (mc.thePlayer!!.heldItem == itemStack || !InventoryUtils2.BLOCK_BLACKLIST.contains(block)) {
