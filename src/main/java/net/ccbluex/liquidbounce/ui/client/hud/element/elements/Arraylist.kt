...
class Arraylist(x: Double = 1.0, y: Double = 2.0, scale: Float = 1F,
    ...
    private val colorModeValue = ListValue("Text-Color", arrayOf("Custom", "Random", "Rainbow","OtherRainbow","ALLRainbow","Bainbow","TwoRainbow","OriginalRainbow","LRainbow"), "Custom")
    ...
    private val rectColorModeValue = ListValue("Rect-Color", arrayOf("Custom", "Random", "Rainbow","OtherRainbow","ALLRainbow","Bainbow","TwoRainbow","OriginalRainbow","LRainbow"), "Rainbow")
        ...
        when (side.horizontal) {
            Horizontal.RIGHT, Horizontal.MIDDLE -> {
                modules.forEachIndexed { index, module ->
                    ...
                    val col = Color(c)
                    val braibow = Color(Rianbowr.get(), col.green / 2 + Rianbowb.get(), col.green / 2 + Rianbowb.get() + Rianbowg.get()).rgb
