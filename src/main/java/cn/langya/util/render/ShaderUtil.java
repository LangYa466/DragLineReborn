...
import cn.langya.util.misc.FileUtil;
...
public class ShaderUtil extends MinecraftInstance {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                case "bloom":
                    ...
                    break;
                default:
                    fragmentShaderID = createShader(mc2.getResourceManager().getResource(new ResourceLocation(fragmentShaderLoc)).getInputStream(), GL_FRAGMENT_SHADER);
                    break;
            }
            glAttachShader(program, fragmentShaderID);

            int vertexShaderID = createShader(mc2.getResourceManager().getResource(new ResourceLocation(vertexShaderLoc)).getInputStream(), GL_VERTEX_SHADER);
    ...
    public ShaderUtil(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc2.getResourceManager().getResource(new ResourceLocation("liquidbounce/shader/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "liquidbounce/vertex.vsh");
    }
    ...
    private int createShader(InputStream inputStream, int shaderType) {
        ...
        GL20.glShaderSource(shader, FileUtil.readInputStream(inputStream));
